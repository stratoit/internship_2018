...
model = Sequential()
model.add(Dense(768, input_dim=230400, kernel_initializer="uniform",activation="relu"))
...
model.fit(trainData, trainLabels, epochs=500, batch_size=20,verbose=1)

# show the accuracy on the testing set
print("[INFO] evaluating on testing set...")
(loss, accuracy) = model.evaluate(testData, testLabels,batch_size=20, verbose=1)
